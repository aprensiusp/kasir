...
body {
    ...
    background-image: url(gambar/18.jpg);
}
h2{
...
<a href="dasboardadmin.php"><i class="fa fa-area-chart"></i>Dashboard</a>
    ...
    <a href="tampilanpenjualan.php"><i class="fa fa-fw fa-tags"></i> Penjualan</a>
       <a href="tampilandetailpenjualan.php"><i class="fa fa-fw fa-tags"></i> Detail Penjualan</a>
...
<button type="text"> <a href="fromdetailpenjualan.php">TAMBAH DETAIL PENJUALAN</a></button>
<br><br>
...
<table id="myTable">
 ...
 <thead>
        ...
        <td><button type="text"> <a href="editdetailpenjualan.php?id=<?php echo $detailpenjualan['PenjualanID']; ?>"><i class="	fa fa-edit"></button></td>
        <td><button type="text"> <a href="hapusdetailpenjualan.php?id=<?php echo $detailpenjualan['PenjualanID']; ?>"><i class="	fa fa-trash"></button></td>
    </tr>
        <?php
        }
        ?>
