...
<button type="text"> <a href="inputpelanggan.html">TAMBAH PELANGGAN</a></button>
<br><br>
...
<table id="myTable">
 ...
 <thead>
        ...
        <td><button type="text"> <a href="editpelanggan.php?id=<?php echo $pelanggan['PelangganID']; ?>"><i class="	fa fa-edit"></button></td>
        <td><button type="text"> <a href="hapuspelanggan.php?id=<?php echo $pelanggan['PelangganID']; ?>"><i class="	fa fa-trash"></button></td>
    </tr>
        <?php
        }
        ?>
